...
<body>
    ...
    <!-- <div id="carouselExampleSlidesOnly" class="carousel homeCarousal" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="assets/img/carousal-1.jpg" class="d-block w-100" alt="carousal-1" draggable="false">
            </div>
        </div>
    </div> -->
